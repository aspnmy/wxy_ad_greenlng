...
?>
    <style type="text/css">
        ...
        .chatPanel .media .mediaImg img { /* width:100%;height:164px;position:absolute;left:0px;*/
            width: 255px;
        }
        ...
        /*media mesg detail*/
        .chatPanel .media .mediaHead { /*height:48px;*/
        ...
        .chatPanel .media .mediaHead .title {
            ...
            display: block;
            max-width: 312px;
            text-align: left; /*height:25px;white-space:nowrap;text-overflow:ellipsis;-o-text-overflow:ellipsis;overflow:hidden;*/
        }
        ...
        .chatPanel .media .mediaFooterbox {
            ...
            <form action="" method="get" class="form-horizontal form">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-10 col-xs-12">
                        ...
                        <input name="submit" type="button" onclick="submitprocess()" value="查看触发过程"
                            ...
                            foreach ($accounts as $account) {
                                ...
                                if (!empty($account['default_account'])) {
                                    ...
                                    <?php if ($development == 1) { ?>
                                        <option
                                            <?php if ($_W['acid'] == $account['default_acid']) { ?>selected<?php } ?>
                                            value="<?php echo '../api.php?id=' . $account['default_acid'] ?>&timestamp=<?php echo $timestamp ?>&nonce=<?php echo $nonce ?>&signature=<?php echo $signString ?>"><?php echo $account['default_account']['name'] ?></option>
                                    <?php } else { ?>
                                        <option
                                            <?php if ($_W['acid'] == $account['default_acid']) { ?>selected<?php } ?>
                                            value="<?php echo $account['default_acid']; ?>"><?php echo $account['default_account']['name'] ?></option>
                                    <?php } ?>
                                    <?php
                                }
                                ?>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-10 col-xs-12">
                        <div class="radio-inline"><input type="radio" name="type" value="text" id="type_text"
                                                         onclick="toggle('text')" checked="checked"/><label
                                for="type_text">&nbsp;文本</label></div>
                        <div class="radio-inline"><input type="radio" name="type" value="image" id="type_image"
                                                         onclick="toggle('image')"/><label for="type_image">
                                &nbsp;图片</label></div>
                        <div class="radio-inline"><input type="radio" name="type" value="location" id="type_location"
                                                         onclick="toggle('location')"/><label for="type_location">&nbsp;位置</label>
                        </div>
                        <div class="radio-inline"><input type="radio" name="type" value="link" id="type_link"
                                                         onclick="toggle('link')"/><label for="type_link">
                                &nbsp;链接</label></div>
                        <div class="radio-inline"><input type="radio" name="type" value="event" id="type_event"
                                                         onclick="toggle('event')"/><label for="type_event">
                                &nbsp;菜单</label></div>
                        <div class="radio-inline"><input type="radio" name="type" value="subscribe" id="type_subscribe"
                                                         onclick="toggle('subscribe')"/><label for="type_subscribe">
                                &nbsp;模拟关注</label></div>
                        <div class="radio-inline"><input type="radio" name="type" value="unsubscribe"
                                                         id="type_unsubscribe" onclick="toggle('unsubscribe')"/><label
                                for="type_unsubscribe">&nbsp;取消关注</label></div>
                        <div class="radio-inline"><input type="radio" name="type" value="other" id="type_unsubscribe"
                                                         onclick="toggle('other')"/><label for="type_unsubscribe">&nbsp;其他</label>
                        </div>
                    </div>
                </div>
                <div class="form-group">
                ...
                <div class="form-group content_type" id="image">
                    ...
                    <div class="col-sm-10 col-xs-12">
                        <input type="text" id="picurl" value="http://www.baidu.com/img/bdlogo.gif"
                               class="form-control"/>
                    </div>
                </div>
        ...
        <div class="col-sm-4" id="demoSendBox">
            <div class="chatPanel form" style="width:300px;">
                ...
                <div id="svposttext" style="text-align:left; padding-bottom:10px;display:none;">
                    <img src="./resource/images/noavatar_middle.gif"
                ...
                <div class="chatItem you">
                    <div id="svtext" style="text-align:left; padding-bottom:10px;display:none;">
                        ...
                        <div class="btn btn-success"
                             style="margin-left: 4px;float: left;max-width: 184px;text-align:left;">回复内容
                        </div>
                        <div style="clear:both;"></div>
                    </div>
