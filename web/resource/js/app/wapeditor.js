!function () {
    window.WAPEDITOR = {
        ...
        modules: [{
            ...
            name: "微页面标题",
            issystem: !0,
            params: {title: "微页面标题", description: "", thumb: "", bgColor: ""}
        }, {
            id: "UCheader",
            name: "会员主页",
            issystem: !0,
            params: {title: "会员主页", cover: "", bgImage: ""}
        }, {
            id: "userCard",
            name: "会员卡",
            issystem: !0,
            params: {title: "会员卡", cover: "", bgImage: "", fields: []}
        }, {
            id: "cardBasic",
            name: "会员卡基本设置",
            issystem: !0,
            params: {
                ...
                grant: {credit1: 0, credit2: 0, coupon: 0, couponTitle: ""},
                grant_rate: 0,
                offset_rate: 0,
                offset_max: 0
            }
        ...
        }, {id: "richText", name: "富文本", params: {bgColor: "", content: "", isfull: !1}}, {
            id: "adImg",
            name: "幻灯片",
            params: {listStyle: 1, sizeType: 1, items: []}
        }, {
            id: "cube",
            name: "图片魔方",
            params: {layout: {}, showIndex: 0, selection: {}, currentPos: {}, currentLayout: {isempty: !0}}
        }, {
            id: "title",
            name: "标题",
            params: {
                title: "",
                template: 1,
                tradition: {subtitle: "", align: "left", bgcolor: "", nav: {title: "", url: "", enable: 0}},
                news: {date: "", author: "", title: "", urlType: 1, url: ""}
            }
        }, {id: "textNav", name: "文本导航", params: {items: []}}, {
            id: "navImg",
            name: "图片导航",
            params: {
        ...
        }, {id: "link", name: "关联链接", params: {items: []}}, {id: "line", name: "辅助线", params: {}}, {
            id: "white",
            name: "辅助空白",
            params: {height: 1}
        }, {
    ...
    !function () {
            ...
            e.modules = [], e.editors = [], e.activeModules = window.activeModules ? window.activeModules : [], e.activeItem = {}, e.activeIndex = 0, e.index = window.activeModules ? window.activeModules.length : 0, e.submit = {
                ...
                a.forEach(e.modules, function (f, g) {
                    if (f.id == d) {
                        ...
                        }), e.activeIndex = c.findIndex(e.activeModules, {index: parseInt(e.index)}), e.activeItem = e.activeModules[e.activeIndex], e.triggerActiveItem(e.activeIndex), void e.index++
                    }
                }), b(".modules").sortable({
                    update: function (a, b) {
                        e.updateSort(a, b)
                ...
                if (b("#module-" + e.activeModules[a].index).size() && b("#editor" + e.activeModules[a].id).size()) {
                    ...
                    var c = b(".app-preview .app-content").offset().top ? b(".app-preview .app-content").offset().top : 200, d = b("#module-" + e.activeModules[a].index).offset().top - c;
                    b("#editor" + e.activeModules[a].id).css("marginTop", d), b("html,body").animate({scrollTop: d}, 500)
                } else e.timer = setTimeout(function () {
                    e.triggerActiveItem(e.activeIndex)
                }, 50)
            }, e.editItem = function (a) {
                var a = c.findIndex(e.activeModules, {index: parseInt(a)});
                ...
                var i = "", j = b(b(".modules").html());
                j.find("div.ng-scope[ng-controller$='Ctrl']").each(function () {
                    var d = c.findIndex(e.activeModules, {index: parseInt(b(this).parent().parent().attr("index"))}), h = "", j = a.copy(e.activeModules[d].params);
                    ...
                    } else"richtext" == k ? (e.activeModules[d] && (e.activeModules[d].params.content = ""), h = b(this).html()) : h = b(this).html();
                    i += '<div type="' + k + '">' + h + "</div>", d++
                });
                var k = e.activeModules[0].params.bgColor;
                i = '<div style="background-color:' + k + '">' + i + "</div>", i = i.replace(/<\!\-\-([^-]*?)\-\->/g, ""), i = i.replace(/ ng\-[a-zA-Z-]+=\"[^\"]*\"/g, ""), i = i.replace(/ ng\-[a-zA-Z]+/g, ""), e.submit.html = i, e.submit.params = a.copy(e.activeModules), h(e.submit.params), e.$apply("submit"), b(d.target).parents("form").submit()
            }, e.updateSort = function (a, d) {
                b(".modules").children().each(function () {
                    var a = c.findIndex(e.activeModules, {index: parseInt(b(this).attr("index"))});
                    e.activeModules[a].displayorder = b(this).index()
                }), e.activeIndex = c.findIndex(e.activeModules, {index: parseInt(d.item.attr("index"))}), e.$apply()
            }, e.init = function (f, g) {
                if (c.isNull(f) && (e.modules = d), c.isArray(f))for (i in f) {
                    var h, j = c.findIndex(d, {id: f[i]});
                    j > -1 && (h = a.copy(d[j]), e.modules.push(h))
                }
                if (c.isArray(g))for (i in g) {
                    var j = c.findIndex(e.modules, {id: g[i]});
        ...
        e.controller("adImgCtrl", ["$scope", function (a) {
            a.addItem = function () {
                ...
                a.activeItem.params.items.push({imgurl: "", title: "", url: ""})
                    ...
                    c && (a.activeItem.params.audio.id = c.id, a.activeItem.params.audio.url = c.attachment, a.$apply(), b(".audio-player-play").click(function () {
                        ...
                        if (c) {
                            ...
                            b(document.body).append(d), d.data("control", b(this)), d.jPlayer({
                                ...
                                solution: "html, flash"
                            }), d.jPlayer("setMedia", {mp3: c}).jPlayer("play"), b(this).find("i").hasClass("fa-stop") ? d.jPlayer("stop") : d.jPlayer("setMedia", {mp3: c}).jPlayer("play")
                        }
                    }).show())
        ...
        }]), e.controller("cardActivityCtrl", ["$scope", function (a) {
        }]), e.controller("cardBasicCtrl", ["$scope", function (a) {
            a.creditnames = creditnames
        }]), e.controller("cardNumsCtrl", ["$scope", function (a) {
        }]), e.controller("cardRechargeCtrl", ["$scope", function (a) {
        }]), e.controller("cardTimesCtrl", ["$scope", function (a) {
        }]), e.controller("componentCtrl", ["$scope", function (a) {
        }]), e.controller("cubeCtrl", ["$scope", function (a) {
            if (a.activeItem.params && a.activeItem.params.layout && c.isEmpty(a.activeItem.params.layout))for (row = 0; row < 4; row++)for (a.activeItem.params.layout[row] = {}, col = 0; col < 4; col++)a.activeItem.params.layout[row][col] = {
                cols: 1,
                rows: 1,
                isempty: !0,
                imgurl: "",
            ...
            b(".layout-table").bind("mouseover", function (a) {
                if ("LI" == a.target.tagName) {
                    ...
                    var c = b(a.target).attr("data-rows"), d = b(a.target).attr("data-cols");
                ...
                a.activeItem.params.currentPos = {row: d, col: e}, a.activeItem.params.selection = {};
                var f = -1, g = 1;
                for (i = d; i < 4; i++) {
                ...
                return b(".layout-table li").removeClass("selected"), a.modalobj = b("#modal-cube-layout").modal({show: !0}), !0
        ...
        }]), e.controller("lineCtrl", ["$scope", function (a) {
        }]), e.controller("linkCtrl", ["$scope", "$http", function (a, d) {
            a.pageSize = c.range(0, 30), a.addItem = function () {
                a.activeItem.params.items.push({
                    title: "",
                    url: "",
                    type: 1,
                    selectCate: {name: "", id: 0},
                    pageSize: 3
                })
            }, a.removeItem = function (d) {
                index = b.inArray(d, a.activeItem.params.items), items = c.clone(a.activeItem.params.items), a.activeItem.params.items = [];
                ...
                return e = "undefined" == typeof e ? "" : e, d.get("./index.php?c=utility&a=link&do=catelist&keyword=" + e).success(function (c, d, e, f) {
                    a.searchCateList = [];
                    var g = c.message;
                    for (i in g)a.searchCateList.push({id: g[i].id, name: g[i].name, children: g[i].children});
                    a.modalobj = b("#modal-search-cate-link").modal({show: !0})
                }), !0
            }, a.selectCateItem = function (b, c, d) {
                return a.currentItem.selectCate = {pid: b, cid: c, name: d}, a.modalobj.modal("hide"), !0
            }
        ...
        }]), e.controller("noticeCtrl", ["$scope", function (a) {
        }]), e.controller("mainCtrl", ["$scope", "$sanitize", function (a, b) {
            ...
            activeItem ? d.activeItem = activeItem : d.activeItem = {
                ...
                d.activeItem.menus.push({
                    ...
                    url: "",
                    submenus: [],
                    icon: {name: "fa-home", color: "#ffffff"},
                    image: "",
                    hoverimage: "",
                    hovericon: ""
                })
            }, d.addSubMenu = function (a) {
                a.submenus.push({title: "标题", url: ""})
            }, d.submit = function (c) {
                function e(a) {
            ...
            a.trustAsHtml = function (a, c) {
                return !a && c && (a = c.replace(/\#quot;/g, "&quot;")), b.trustAsHtml(a)
            }
        }]), e.controller("textNavCtrl", ["$scope", function (a) {
            a.addItem = function () {
                a.activeItem.params.items.push({title: "", url: ""})
            }, a.removeItem = function (d) {
                index = b.inArray(d, a.activeItem.params.items), items = c.clone(a.activeItem.params.items), a.activeItem.params.items = [];
                for (i in items)i != index && a.activeItem.params.items.push(items[i])
            }
        ...
        }]), e.controller("userCardCtrl", ["$scope", function (e) {
            e.init(null, ["cardBasic", "cardActivity", "cardNums", "cardTimes", "cardRecharge"]), e.activeModules[1].params.discounts = discounts, e.addFields = function () {
                e.activeItem.params.fields.push({title: "", require: 1, bind: "", issystem: 0})
            }, e.removeFields = function (a) {
                return "mobile" == a.bind || "realname" == a.bind ? !1 : (e.activeItem.params.fields = c.without(e.activeItem.params.fields, a), !1)
            }, e.addNums = function () {
                e.activeItem.params.nums.push({recharge: "", num: ""})
            }, e.removeNums = function (a) {
                return e.activeItem.params.nums = c.without(e.activeItem.params.nums, a), !1
            }, e.addRecharges = function () {
                e.activeItem.params.recharges.push({condition: "", back: "", backtype: "0", backunit: "元"})
            }, e.removeRecharges = function (a) {
                return e.activeItem.params.recharges = c.without(e.activeItem.params.recharges, a), !1
            }, e.addTimes = function () {
                e.activeItem.params.times.push({recharge: "", time: ""})
            }, e.removeTimes = function (a) {
                return e.activeItem.params.times = c.without(e.activeItem.params.times, a), !1
            }, e.selectCoupon = function () {
                util.coupon(function (a) {
                    e.activeItem.params.grant.couponTitle = a.title, e.activeItem.params.grant.coupon = a.couponid, e.$apply("activeItem")
                }, {multiple: !1})
            }, e.addThumb = function (a) {
                d.show(function (b) {
                    e.activeItem.params[a] = b.url, e.$apply("activeItem")
                }, {direct: !0, multiple: !1})
            }, e.addBgThumb = function () {
                d.show(function (a) {
                    e.activeItem.params.background.image = a.url, e.$apply("activeItem")
                }, {direct: !0, multiple: !1})
            }, e.editItem = function (d) {
                "string" == typeof d && a.forEach(e.activeModules, function (a) {
                    a.id == d && (d = a.index)
                });
                var d = c.findIndex(e.activeModules, {index: parseInt(d)});
                d > -1 && (e.activeIndex = d, e.activeItem = e.activeModules[d]), -1 == b.inArray(e.activeItem.id, e.editors) && e.editors.push(e.activeItem.id), e.triggerActiveItem(d)
            }, e.fansFields = fansFields, e.editItem(0)
            ...
            a.init(null, ["UCheader"]), a.addThumb = function (b) {
                ...
                a.activeMenus.push({icon: "", css: {icon: {icon: "fa fa-external-link"}}, name: "", url: ""})
            ...
            var a = {
                ...
                scope: {colorValue: "=ngMyColor", colorDefault: "=ngMyDefaultColor"},
                link: function (a, c, d) {
            ...
            var a = {
                scope: {value: "=?ngMyValue", params: "=?ngMyParams"},
                ...
                link: function (b, c, d) {
                    c.data("editor") || (c.find("textarea").attr("id", "editor" + (new Date).getTime()), a = UE.getEditor(c.find("textarea").attr("id"), ueditoroption), c.data("editor", a), a.addListener("contentChange", function () {
                        b.value = a.getContent(), b.value && (b.params = b.value.replace(/\&quot;/g, "#quot;")), b.$root.$$phase || b.$apply("value")
                    }), a.addListener("ready", function () {
                        !b.value && b.params && (b.value = b.params.replace(/\#quot;/g, "&quot;")), b.value && a && a.getContent() != b.value && a.setContent(b.value), b.$watch("value", function (b) {
            ...
            var a = window.WAPEDITOR.templates["iconer-template"], c = {
                scope: {image: "=ngMyImage", icon: "=ngMyIcon"},
                transclude: !0,
                template: a,
                link: function (a, c, e) {
            ...
            var d = {
                ...
                scope: {url: "=ngMyUrl", title: "=ngMyTitle"},
                link: function (d, e, f) {
                    e.find(".input-group-btn").mouseover(function (a) {
                        ...
                        d.modalobj = util.dialog("请选择链接", ["./index.php?c=utility&a=link&callback=selectLinkComplete"], "", {containerName: "link-search-system"}), d.modalobj.modal({keyboard: !1}), d.modalobj.find(".modal-body").css({
                            height: "680px",
                            "overflow-y": "auto"
                        ...
                        var f = {};
                        f.content = window.WAPEDITOR.templates["linker-news-content"], f.footer = "", f.newsitem = window.WAPEDITOR.templates["linker-news-item"], b("#link-search-news")[0] ? d.modalobj = b("#link-search-news").data("modal") : (d.modalobj = util.dialog(f.header, f.content, f.footer, {containerName: "link-search-news"}), d.modalobj.find(".modal-body").css({
                            height: "680px",
                            "overflow-y": "auto"
                        }), d.modalobj.modal("show"), d.modalobj.on("hidden.bs.modal", function () {
                            d.modalobj.remove()
                        ...
                        var f = {};
                        f.content = window.WAPEDITOR.templates["linker-page-content"], f.footer = "", f.pageItem = window.WAPEDITOR.templates["linker-page-item"], b("#link-search-page")[0] ? d.modalobj = b("#link-search-page").data("modal") : (d.modalobj = util.dialog(f.header, f.content, f.footer, {containerName: "link-search-page"}), d.modalobj.find(".modal-body").css({
                            height: "680px",
                            "overflow-y": "auto"
                        }), d.modalobj.modal("show"), d.modalobj.on("hidden.bs.modal", function () {
                            d.modalobj.remove()
                    ...
                    }, d.addTelLinker = function () {
                        var a = {};
                        a.content = window.WAPEDITOR.templates["linker-tel-content"], d.modalobj = util.dialog("一键拨号", a.content), d.modalobj.modal("show"), d.modalobj.find(".btn-primary").click(function () {
                            d.addLink("tel:" + d.modalobj.find("#telphone").val(), ""), d.$apply("url", "title"), d.modalobj.modal("hide")
                        })
                    }
                }
            };
