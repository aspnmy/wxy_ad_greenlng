define(["jquery", "underscore", "webuploader", "jquery.jplayer", "bootstrap", "filestyle"], function (a, b, c) {
    var d = {
        defaultoptions: {
            ...
            var d = this, e = d.options.type, f = d.options.mode, g = d.modalobj.find("#wechat_history_image");
            ...
            var d = this, e = d.options.type, f = d.options.mode, g = d.modalobj.find("#wechat_history_audio");
            return a.getJSON("./index.php?c=utility&a=wechat_file&do=browser", {
                page: c,
                type: e,
                mode: f,
            ...
            var b = this, c = b.modalobj.find("#wechat_history_audio");
            ...
            var d = this, e = d.options.type, f = d.modalobj.find("#wechat_history_video");
            return a.getJSON("./index.php?c=utility&a=wechat_file&do=browser", {
                page: c,
                type: e,
                psize: 5
            ...
            function b(b) {
                var c = a('<li id="' + b.id + '"><p class="title">' + b.name + '</p><p class="imgWrap"></p></li>'), e = a('<div class="file-panel"><span class="cancel">删除</span></div>').appendTo(c), f = c.find("p.progress span"), g = c.find("p.imgWrap"), h = a('<p class="error"></p>'), j = function (a) {
                    switch (a) {
                        case"exceed_size":
                            text = "文件大小超出";
                            break;
            ...
            function g() {
                var a, b = "";
                if ("ready" === state) {
                    if ("" == i.options.mode)var e = i.modalobj.find(".nav-pills li.active").attr("data-mode"); else var e = i.options.mode;
            ...
            var j = a("#wechat_uploader"), k = a('<ul class="filelist"><li class="fileinput-button js-add-image" id="wechat_filePicker2" style="display:none;"> <a href="javascript:;" class="fileinput-button-icon">+</a></li></ul>').appendTo(j.find(".queueList")), l = j.find(".statusBar"), m = l.find(".info"), n = j.find(".uploadBtn"), o = j.find(".placeholder"), p = l.find(".progress").hide();
            j.find(".btn-primary");
            ...
            var q = {
                pick: {id: "#wechat_filePicker", label: "点击选择图片", multiple: !0},
                dnd: "#wechat_dndArea",
                paste: "#wechat_uploader",
                swf: "./resource/componets/webuploader/Uploader.swf",
                server: "./index.php?c=utility&a=wechat_file&do=upload",
                chunked: !1,
                compress: {quality: 80, preserveHeaders: !0, noCompressIfLarger: !0, compressSize: 1048576},
            ...
            q = a.extend({}, q, i.options.uploader), q.pick.multiple = i.options.multiple, d = c.create(q), d.uploadedFiles = [], d.addButton({
                ...
                fileCount = 0, fileSize = 0, accept = 0, d.uploadedFiles = [], a.each(d.getFiles(), function (a, b) {
                    e(b)
                }), f(), d.reset(), d.refresh(), a("#wechat_dndArea").removeClass("element-invisible"), a("#wechat_uploader").find(".filelist").empty(), a("#wechat_filePicker").find(".webuploader-pick").next().css({left: "190px"});
            ...
            function b(b) {
                var e = a('<li id="' + b.id + '"><p class="title" style="top:40px;">' + b.name + '</p><p class="imgWrap" style="top:30px;"></p></li>'), f = a('<div class="file-panel"><span class="cancel">删除</span></div>').appendTo(e), g = e.find("p.progress span"), h = e.find("p.imgWrap"), j = a('<p class="error"></p>'), l = function (a) {
                    switch (a) {
                        case"exceed_size":
                            text = "文件大小超出";
                            break;
            ...
            var q = {
                pick: {id: "#wechat_filePicker", label: "点击选择音频", multiple: !0},
                dnd: "#wechat_dndArea",
                paste: "#wechat_uploader",
                swf: "./resource/componets/webuploader/Uploader.swf",
                server: "./index.php?c=utility&a=wechat_file&do=upload",
            ...
            var b = this;
            b.modalobj.find("#li_upload_perm a").html("上传永久视频"), b.modalobj.find("#li_upload_temp a").html("上传临时视频(保留3天)"), b.modalobj.find(".modal-body").append(this.buildHtml().uploaderVoiceDialog), b.modalobj.find("#fileUploader_video_form").find(':file[name="file"]').filestyle({buttonText: "选择视频文件"}), b.modalobj.find("#video").find("button.btn-primary").off("click"), b.modalobj.find("#video").find("button.btn-primary").on("click", function () {
                var c = "./index.php?c=utility&a=wechat_file&do=upload&types=video", d = b.modalobj.find(".nav-pills li.active").attr("data-mode");
